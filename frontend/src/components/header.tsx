...
<nav className="bg-neutral-primary fixed w-full z-20 top-0 start-0 border- border-default">
  ...
  />
  <span
    className="self-center text-xl text-heading font-semibold whitespace-nowrap text-[#2d3766]"
  ...
  <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" className="flex text-sm bg-neutral-primary rounded-full md:me-0 focus:ring-4 focus:ring-neutral-tertiary" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        ...
        <img className="w-8 h-8 rounded-full" src="/images/Devbuddylogo2.png" alt="user photo"></img>
      </button>
...
>>>>>>> 86735f0 (-implementing code editor)
  </div>
</nav>
